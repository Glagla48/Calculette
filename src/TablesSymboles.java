...
class TablesSymboles {
    ...
    public AdresseType getFunction(String function) {
	AdresseType l = _tableFonctions.get(function);
	if (l != null)
	    return l;
    ...
    public boolean newFunction(String function, int label, String t) {
        AdresseType fat = _tableFonctions.get(function);
	if ( fat!= null ) {
	    System.err.println("Fonction \""+ function + "\" déjà définie avec type de retour \"" + fat.type +"\".");
	    return false;
	}
	_tableFonctions.put(function, new AdresseType(label,t));
	return true;
    }
}
