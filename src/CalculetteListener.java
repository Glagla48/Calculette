...
public interface CalculetteListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CalculetteParser#instructionthen}.
	 * @param ctx the parse tree
	 */
	void enterInstructionthen(CalculetteParser.InstructionthenContext ctx);
	/**
	 * Exit a parse tree produced by {@link CalculetteParser#instructionthen}.
	 * @param ctx the parse tree
	 */
	void exitInstructionthen(CalculetteParser.InstructionthenContext ctx);
	/**
	 * Enter a parse tree produced by {@link CalculetteParser#instructionelse}.
	 * @param ctx the parse tree
	 */
	void enterInstructionelse(CalculetteParser.InstructionelseContext ctx);
	/**
	 * Exit a parse tree produced by {@link CalculetteParser#instructionelse}.
	 * @param ctx the parse tree
	 */
	void exitInstructionelse(CalculetteParser.InstructionelseContext ctx);
	/**
